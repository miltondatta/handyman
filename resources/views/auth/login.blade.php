                ...
                <div class="card-body">
                   <div class="auth-logo">
                      <a href="{{route('frontend.index')}}">
                        <img src="{{ getSingleMedia(settingSession('get'),'site_logo',null) }}" class="img-fluid rounded-normal" alt="app_logo">
                        <!--<img src="http://localhost/handyman/public/images/logo.png" class="img-fluid rounded-normal" alt="app_logo"> -->
                      </a>
                   </div>
