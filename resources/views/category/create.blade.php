                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="col-md-2 mb-2">
                                @php
                                    ...
                                    //dd($categorydata->media[0]->file_name);
                                @endphp
                                
                                <img id="category_image_preview" src="{{getSingleMedia($categorydata,'category_image')}}" alt="#" width="150px" class="attachment-image mt-1" style="background-color:{{ $extention == 'png' ? $categorydata->color : '' }}">
