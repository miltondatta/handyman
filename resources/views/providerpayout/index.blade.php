...
<div class="card">
        ...
        <div class="row justify-content-between">
            <div>
                <div class="col-md-12">
                  <form action="{{ route('providerpayout.bulk-action') }}" id="quick-action-form" class="form-disabled d-flex gap-3 align-items-center">
                    @csrf
                ...
                data--submit="{{ route('providerpayout.bulk-action') }}"
                data-datatable="reload" data-confirmation='true'
                data-title="{{ __('providerpayout',['form'=>  __('providerpayout') ]) }}"
                title="{{ __('providerpayout',['form'=>  __('providerpayout') ]) }}"
    ...
    <script>
        ...
        window.renderedDataTable = $('#datatable').DataTable({
                ...
                ajax: {
                  "type"   : "GET",
                  "url"    : '{{ route("providerpayout.index_data") }}',
                  "data"   : function( d ) {
                    d.search = {
                      value: $('.dt-search').val()
                    };
